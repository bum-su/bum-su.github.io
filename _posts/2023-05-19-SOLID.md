...
LSP를 준수하기 위해서는, Bird를 상속받는 모든 서브클래스가 fly 함수를 제대로 실행할 수 있어야 합니다. 그래서 이런 경우에는 Bird 클래스를 분리하여 FlyingBird와 NonFlyingBird 클래스로 만들고, 펭귄은 NonFlyingBird를 상속받도록 변경할 수 있습니다.
